...
const OPENING: Record<string, string> = {
  ...
  'shift.report': 'Viết báo cáo ca cho nhóm quản lý: vi phạm thật / báo oan theo camera, sự cố vận hành đã tự xử lý, việc khắc phục còn mở / quá hạn (read_agent_activity trả openActions, overdueActions), việc cần người làm. Gửi bằng escalate (không violationId) rồi trả lời lại nội dung báo cáo.',
  'weekly.report': 'Viết báo cáo TUẦN (7 ngày gần nhất) cho ban chỉ huy: theo công trường và camera — vi phạm thật, báo oan, camera báo oan nhiều nhất, việc còn mở, việc khắc phục còn mở / quá hạn (read_agent_activity trả openActions, overdueActions), sự cố vận hành đáng chú ý. Dùng search_violations và read_agent_activity để lấy số liệu, gửi bằng escalate (không violationId), rồi trả lời lại bằng bản báo cáo markdown ngắn gọn.',
